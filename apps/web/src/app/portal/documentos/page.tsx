...
export default function PortalDocumentosPage() {
    ...
    const { data: documentos, isLoading } = useQuery({
        ...
        queryFn: () => documentosApi.getMios().then((r) => r.data),
    });
    ...
    const uploadMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['mis-documentos'] });
            setModalOpen(false);
        ...
        <div>
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">Documentos de tus expedientes</p>
                </div>
                <button
            ...
            <div className="bg-white rounded-xl border overflow-hidden">
                ...
                {!isLoading && documentos?.length === 0 && (
                    <div className="p-8 flex flex-col items-center justify-center text-gray-400 gap-3">
                        ...
                        <p className="text-sm">No tienes documentos disponibles aún.</p>
                    </div>
                )}
                {documentos?.length > 0 && (
